...
const char ssid[] = "S21";  // your network SSID (name)
const char pass[] = "12345678";   // your network password        
int statusCode = 0;
WiFiClient  client;

//---------Channel Details---------//
unsigned long counterChannelNumber = 2523840;            // Channel ID
const char * myCounterReadAPIKey = "AH2IXNMSUG4RJ6NB"; // Read API Key
